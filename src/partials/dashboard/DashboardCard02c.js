...
function DashboardCard02a() {
  ...
  useEffect(() => {
    fetch("https://datax-team9.herokuapp.com/subway_covid")
      ...
      .then(response => response.json()
        .then(data => {
          setData2(Object.values(data["Buses: Total Estimated Ridership"]))
          // setDates([0,1,2,3,4,5])
          // setData([10,20,30,40,50])
          setLoading2(true)
        })
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">NYC Public Transportation Ridership During the Pandemic</h2>
