...
function DashboardCard02a() {
    ...
    fetch("https://datax-team9.herokuapp.com/subway_covid")
      .then(response => response.json()
        .then(data => {
          ...
          // }
          setDates(new_dates)
          setData(Object.values(data["Subways: Total Estimated Ridership"]))
  ...
  const chart = {
    ...
    datasets: [
      // Indigo line
      {
        label: "Subway ridership during Pandemic",
        data: chartData,
      ...
      {
        data: chartData2,
        label: "Subway ridership pre-pandemic",
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">NYC Subway Ridership Pre-Pandemic vs. during Pandemic</h2>
        <div className="text-xs font-semibold text-gray-400 uppercase mb-1">Subway ridership during Pandemic</div>
        <div className="text-xs font-semibold text-gray-400 uppercase mb-1">Subway ridership during pre-pandemic</div>
        {/* <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 mr-2">2.25M</div>
          <div className="text-sm font-semibold text-white px-1.5 bg-red-500 rounded-full">-</div>
        </div> */}
