    ...
    fetch("https://datax-team9.herokuapp.com/subway_covid")
      .then(response => response.json()
        .then(data => {
          ...
          // }
          setDates(new_dates)
          setData(Object.values(data["Equivalent Ridership from Previous Year"]))
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">NYC Public Transportation Ridership pre-Pandemic</h2>
