...
function DashboardCard03a() {
      ...
      .then(response => response.json()
        .then(data => {
          ...
          for (var key in data["Buses: Total Estimated Ridership"]) {
            new_data.push(data["Buses: Total Estimated Ridership"][key]/1000000)
  ...
  const chart = {
    ...
    datasets: [
      // Indigo line
      {
        label: "Bus ridership in Millions",
        data: chartData,
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">NYC Bus ridership vs. COVID-19 Cases</h2>
...
export default DashboardCard03a;
