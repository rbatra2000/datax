    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium group-hover:text-gray-800">Jane Doe</span>
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
            ...
            <div className="text-xs text-gray-500 italic">New York City, NY</div>
          </div>
          <ul>
            <li>
              <Link
