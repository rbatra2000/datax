...
const MapChart = () => {
  return (
    <ComposableMap>
      ...
      <Marker coordinates={[-122.2585, 37.8719]}>
        <circle r={8} fill="#F53" />
      </Marker>
      <Marker coordinates={[-77.0091, 38.8899]}>
        <circle r={8} fill="#F53" />
      </Marker>
    </ComposableMap>
  );
      ...
      <div>
          ...
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">City Population</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div className="row">
                  <div className="col-9">
                    <div className="d-flex align-items-center align-self-start">
                      <h3 className="mb-0">F</h3>
                      <p className="text-danger ml-2 mb-0 font-weight-medium">-2.4% V/C</p>
                    </div>
                  </div>
                  <div className="col-3">
                    <div className="icon icon-box-success">
                ...
                <h6 className="text-muted font-weight-normal">Level of Service (LOS)</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div className="row">
                  <div className="col-9">
                    <div className="d-flex align-items-center align-self-start">
                      <h3 className="mb-0">46 min</h3>
                      <p className="text-danger ml-2 mb-0 font-weight-medium">+17%</p>
                    </div>
                  </div>
                  <div className="col-3">
                ...
                <h6 className="text-muted font-weight-normal">Traffic Delay</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div className="row">
                  <div className="col-9">
                    <div className="d-flex align-items-center align-self-start">
                      ...
                      <p className="text-success ml-2 mb-0 font-weight-medium">+75%</p>
                    </div>
                  </div>
                  <div className="col-3">
                    <div className="icon icon-box-success ">
                ...
                <h6 className="text-muted font-weight-normal">Transportation Accessibility Score</h6>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex flex-row justify-content-between">
                  <h4 className="card-title mb-1">Current Tasks</h4>
                  ...
                  <div className="col-12">
                    <div className="preview-list">
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">Restructure Bus Routes</h6>
                            <p className="text-muted mb-0">Bus</p>
                          </div>
                      ...
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">Modify Subway Times</h6>
                            <p className="text-muted mb-0">Train</p>
                          </div>
                          <div className="mr-auto text-sm-right pt-2 pt-sm-0">
                      ...
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">Interview Community</h6>
                            <p className="text-muted mb-0">Research</p>
                          </div>
                          <div className="mr-auto text-sm-right pt-2 pt-sm-0">
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex">
                            ...
                            <span className="pl-2">[Insert City Planner Name Here]</span>
                          </div>
                        </td>
                        <td> 02312 </td>
                        <td> $14,500 </td>
        ...
        <div className="row">
          ...
          <div className="col-md-6 col-xl-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Marker Map</h4>
                <MapChart />
              </div>
            </div>
          </div>
          <div className="col-md-6 col-xl-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Live Photos</h4>
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">[Some stat about spread of communities]</h4>
                <div className="row">
